    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Download__6F0F98BF04137FF4", x => x.FileId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SurveyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RespondentName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    DateCompleted = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Survey__A5481F7D1DE96033", x => x.SurveyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlawProbability = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    ReUseProbability = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__SurveyAn__5B789DC82519D4ED", x => x.AnalysisId);
                    table.ForeignKey(
                        name: "FK_SurveyAnalysis_Survey",
                        column: x => x.SurveyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SurveyRe__1AAA646C25AEEA33", x => x.ResponseId);
                    table.ForeignKey(
                        name: "FK_SurveyResponse_Question",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "QuestionId");
                    table.ForeignKey(
                        name: "FK_SurveyResponse_Survey",
                        column: x => x.SurveyId,
                        principalTable: "Survey",
                        principalColumn: "SurveyId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__SurveyAn__A5481F7C82E76A2A",
