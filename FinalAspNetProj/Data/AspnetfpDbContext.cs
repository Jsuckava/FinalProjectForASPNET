...
public partial class AspnetfpDbContext : IdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.QuestionId).HasName("PK__SurveyQu__0DC06FAC7587ABD8");
            entity.ToTable("SurveyQuestion");
            entity.Property(e => e.MaxRating).HasDefaultValue(4);
            entity.Property(e_ => e_.QuestionText).HasMaxLength(500);
        });
